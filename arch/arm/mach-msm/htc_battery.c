...
int htc_battery_update_change(void)
{
	...
	/*
	 * Do not run this function if battery init hasn't been ran yet
	 * Marc Alexander (c) 2013
	 */
	if (!htc_battery_initial) {
		pr_info("[BATT] %s() called before init\n", __func__);
		return 0;
	}
